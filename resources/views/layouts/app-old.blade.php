        ...
        <div id="logoArea" class="navbar">
            ...
            <div class="navbar-inner">
                ...
                <ul id="topMenu" class="nav my-pull-right">
                    <li class=""><a href="{{ route('faq') }}"></a></li>
                    <li class="">{{trans('auth.failed')}}</li>
                    <li class="">
                        <select class="selectpicker" data-width="fit">
                            <option @if(App::getLocale() == 'en') selected @endif value="en" data-content='<span class="flag-icon flag-icon-us"></span> English'>English</option>
                            <option @if(App::getLocale() == 'fr') selected @endif value="fr" data-content='<span class="flag-icon flag-icon-mx"></span> Español'>France</option>
                            <option @if(App::getLocale() == 'ru') selected @endif value="ru"  data-content='<span class="flag-icon flag-icon-mx"></span> Español'>Ruusian</option>
                        </select>
                    </li>
                    ...
                    @if(isset($categories))
                        @if(count($categories))
                            ...
                            @foreach($categories as $category)
                                <li><a href="{{ route('products.productsBySubcategory', $category->id) }}"> {{ strtoupper($category->name) }} [ {{$category->products->count()}} ]</a>
...
<script >
    $('.selectpicker').change(function () {
        document.location.href="/language/"+$(this).val();
    })
</script>
@yield('scripts')
